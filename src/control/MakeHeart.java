...
@WebServlet("/MakeHeart.do")
public class MakeHeart extends HttpServlet {
	...
	protected void doMakeHeart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * System.out.println(thatemail); System.out.println(myemail);
		 */
