...
@WebServlet("/Tailmenu1.do")
public class Tailmenu1 extends HttpServlet {
	...
	protected void doTailMenu1(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("/tailmenu/tailmenu1.jsp?nowserver="+nowserver);
