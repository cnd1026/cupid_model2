...
@WebServlet("/Tailmenu4.do")
public class Tailmenu4 extends HttpServlet {
	...
	protected void doTailMenu4(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("/tailmenu/tailmenu4.jsp?nowserver="+nowserver);
