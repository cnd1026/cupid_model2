...
@WebServlet("/Tailmenu3.do")
public class Tailmenu3 extends HttpServlet {
	...
	protected void doTailMenu3(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("/tailmenu/tailmenu3.jsp?nowserver="+nowserver);
