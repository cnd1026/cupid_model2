...
@WebServlet("/ActiveLookYou.do")
public class ActiveLookYou extends HttpServlet {
	private static final long serialVersionUID = 1L;
   
    public ActiveLookYou() {
        super();
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		doLookYou(request, response);
	}
	...
	protected void doLookYou(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
		...
		Vector<LookmeBean> lv = dao.lookscount1(email, startRow, endRow);
		...
		Vector<ActivememBean> lmv = dpo.getWho1(nowyear, startRow, endRow, email);
		String lmvcount = Integer.toString(lmv.size());
		request.setAttribute("lmv", lmv);
		request.setAttribute("lmvcount", lmvcount);
		
		Vector<LookmeBean> v = dao.looksCheck(email, lookemail);
