...
@WebServlet("/Tailmenu6.do")
public class Tailmenu6 extends HttpServlet {
	...
	protected void doTailMenu6(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("/tailmenu/tailmenu6.jsp?nowserver="+nowserver);
