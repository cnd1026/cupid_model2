...
<div style="width:100%; min-width:1200px; height:6%; float:left;">
	<div style="width:95%; min-width:950px; height:100px; margin-left:auto; margin-right:auto; box-shadow:3px 3px 8px 1px gray;">
		<form name="searchThat" action="SearchAllMember.do" method="post">
...
<div style="float:left; width:100%; min-width:1200px; height:0px; padding-bottom:8%; color:#565656;">
	<div style="float:left; width:10%; height:0px; padding-bottom:8%; color:#565656; margin-left:4%; margin-right:1%; cursor:pointer;">
		<c:if test="${block > 1 }">
			...
			<a href="SearchAllMember.do?searchserver=${nowserver }&pageNum=${my_page }&searchgender=${gender }&searchlevel=${levelgo }&searchfirstage=${firstage }&searchlastage=${lastage }">
				<b>&#60;&#60;</b> 처음페이지
			</a>
		</c:if>
	</div>
	...
	<div style="float:left; width:30%; height:0px; padding-bottom:8%; text-align:center;">
		<c:forEach var="i" begin="${first_page + 1 }" end="${last_page }">
			...
			<c:if test="${pageNum != i }">
				<a href="SearchAllMember.do?searchserver=${nowserver }&pageNum=${i }&searchgender=${gender }&searchlevel=${levelgo }&searchfirstage=${firstage }&searchlastage=${lastage }" style="font-size:25px; color:#777;">${i }</a>&nbsp;
			</c:if>
		</c:forEach>
	</div>
	...
	<div style="float:left; width:10%; height:0px; padding-bottom:8%; color:#565656; cursor:pointer;">
		<c:if test="${block < total_block }">
			...
			<a href="SearchAllMember.do?searchserver=${nowserver }&pageNum=${my_page2 }&searchgender=${gender }&searchlevel=${levelgo }&searchfirstage=${firstage }&searchlastage=${lastage }">
				다음페이지로 <b>&#62;</b>
			</a>
		</c:if>
	</div>
