...
<form action="PostModifyProc.do?nowserver=${nowserver }" method="post" enctype="multipart/form-data">
<input type=hidden name=nowserver value="${nowserver }">
<input type=hidden name=uid value="${pbean.uid }">
	<div style="width:100%; height:20px;"></div>
	<div style="width:930px; height:200px; box-shadow:3px 3px 8px 1px gray; padding:10px; font-size:16px;">
		<!-- 사진 -->
		<div style="width:150px; height:200px; border:0.1px solid #CCC;background-image:url(/cupid/upload/${pbean.file_rename}); background-position:50%; background-repeat:no-repeat; background-size:cover; float:left;"></div>
		<!-- 공백 -->
		...
		<div style="width:590px; height:200px; float:left; text-align:left;">
			...
			<div style="width:590px; height:150px; margin-top:20px; float:left; overflow:hidden; font-size:16px;">
				<textarea id="post" name="post" style="width:580px; height:140px; border:0.1px solid #CCC; resize:none;">${pbean.post }</textarea>
			</div>
		</div>
		<!-- 세로공백 -->
	...
	<div style="width:910px; height:30px; box-shadow:3px 3px 8px 1px gray; padding:20px; font-size:16px; text-align:center;">
		바꾸고 싶은 파일 <input type="file" name="file1"><font color=red>(jpg 이미지 파일만 지원합니다.)</font>
	</div>
	<div style="width:100%; height:20px;"></div>
	<div style="width:200px; height:100px; margin-top:30px;">
		<input type="submit" value="수정하기" style="width:200px; height:50px; font-size:20px; font-weight:500; color:#666; box-shadow:3px 3px 8px 1px gray;">
	</div>
</form>
</div>
