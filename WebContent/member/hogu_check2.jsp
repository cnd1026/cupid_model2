...
④ 이용자가 변경된 약관사항에 동의하지 않는 경우에는 서비스의 이용이 불가하며 이용자는 이용 계약을 해지할 수 있습니다/li>
제4조 (전자지급결제대행서비스의 종류)
...
주소: 서울시 구로구 디지털로 33길 28, 5층(구로동, 우림이비지센터 1차) 엔에이치엔한국사이버결제 주식회사 
...
부칙 < 제 5 호, 2016.11.11. >
본 약관은 2016년 11월 21일부터 시행한다. (제 17조 신설, 제3조 제3항 및 제4항, 제9조 제2항, 제14조 제1항, 제16조, 제18조 제3항 일부 개정)

부칙 < 제 6 호, 2016.11.28. >
본 약관은 2016년 11월 28일부터 시행한다. (제12조 제1항 삭제, 제6조 제2항, 제8조 제1항 및 제2항, 제9조 제2항, 제19조 개정, 제20조 제1항 신설)
...
"주식회사 한국사이버결제"(이하 "회사")는 이용자의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호에 관한 법률" 및 "개인정보보호법"과 "전자상거래 등에서의 소비자 보호에 관한 법률"을 준수하고 있습니다. 회사는 이용자의 개인정보를 [개인정보의 수집목적]에서 고지한 범위 내에서 사용하며, 이용자의 사전 동의 없이는 동 범위를 초과하여 이용하거나 원칙적으로 이용자의 개인정보를 외부에 제공 또는 위탁하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.
...
본인 인증, 거래승인, 요금정산을 위한 거래정보전송, 수납 등 요금 정산 관련 업무

2)결제수단별 제공하는 개인정보의 항목(신용카드)
이용자의 서비스 거래정보(이용 상점 정보, 상품명, 주문금액 등)

3)개인정보를 제공받는 자의 개인정보 보유 및 이용 기간
: 해당 사업자가 이미 보유하고 있는 개인정보이기 때문에 별도로 저장하지 않음. 단, 법령의 규정에 의한 거래 내역 등을 보관(건당 거래금액이 1만원 이하의 경우 1년, 1만원 초과의 경우 5년)

나.이용자의 거래 상대방
1)개인정보를 제공받는 자의 개인정보 이용 목적
거래 승인 확인, 취소 및 환불, 거래 대금의 정산, 거래 확인 요청에 대한 응대 및 확인

2)제공하는 개인정보의 항목
이용자의 서비스 거래 정보(각 결제 수단의 거래 승인 여부, 거래 승인 실패 원인, 결제 일시, 결제금액 등)

3)개인정보를 제공받는 자의 개인정보 보유 및 이용 기간
법령의 규정에 의한 거래 내역을 보관(건당 거래금액이 1만원 이하의 경우 1년, 1만원 초과의 경우 5년)

2. 개인정보의 취급 위탁
회사는 아래와 같이 이용자로부터 수집한 개인정보를 제3자에게 위탁 합니다.
