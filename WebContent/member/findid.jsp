...
<div class="loginform" align=center>
	<div style="width:100%; font-size:15px; font-weight:700; color:#FFF; text-align: left;">
		<a href="Login.do" style="cursor:pointer; color: #FFF;">뒤로</a>
	</div>
	<div style="width:25%; font-size:20px; font-weight:700; color:#FFF;">아이디 찾기</div>
	<form name="login" onsubmit="return send()" action="/cupid/FindId.do" method="post">
